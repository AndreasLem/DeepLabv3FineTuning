...
def main(data_directory, exp_directory, epochs, batch_size):
    ...
    optimizer = torch.optim.Adam(model_dlv3.parameters(), lr=1e-4)
    ...
    torch.save(model_dlv3, exp_directory / 'weights.pt')
